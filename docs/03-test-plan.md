...
> **T-8d technique matters.** An ice bath only sits at 0 °C if it is a *stirred slurry of crushed
> ice and water*, not ice cubes in water. Let it equilibrate, keep stirring, and immerse the probe
...
| T-5c.iv | 5c.iv | Unplug a probe for 20 s, then warm the other past 50 °C. | The gap and the off-scale region are obviously different from each other. | |
